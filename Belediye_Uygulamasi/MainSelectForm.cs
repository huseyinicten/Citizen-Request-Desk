...
namespace Belediye_Uygulamasi
{
    ...
    public partial class MainSelectForm : Form
    {
        ...
        private void MainSelectForm_Resize(object sender, EventArgs e)
        {
            ...
            {
                labelHead.Text = "Pursaklar Belediyesi";
            }
            else
            {
                labelHead.Text = "Pursaklar Belediyesi Uygulaması | Ana Sayfa";
            }
        }
        ...
        private void eBelediyeToolStripMenuItem_Click(object sender, EventArgs e)
        {
